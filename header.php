...
<div class="top-header">
	...
	<div class="top-header__cart">
		...
		<a class="top-header__cart-link" href="<?php echo esc_url( home_url( '/' ) ); ?>cart/" title="<?php _e( 'View your shopping cart' ); ?>"><i class="fa-solid fa-cart-shopping"></i> Your Cart: <?php echo sprintf ( _n( '%d item', '%d items', WC()->cart->get_cart_contents_count() ), WC()->cart->get_cart_contents_count() ); ?>&nbsp;&ndash;&nbsp;<?php echo WC()->cart->get_cart_total(); ?></a>
	</div>
